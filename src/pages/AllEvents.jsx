...
export default function AllEvents() {
  ...
  const events = [
    {
      ...
      title: "Robo Race",
      desc:
        "Experience high-speed robotics in this intense techno challenge.".repeat(
          10
        ),
      img: img1,
      category: "techno",
  ...
  return (
    <section className="min-h-screen bg-gray-900 text-white pt-24 pb-40 px-4 md:px-10">
      <EventsHero />
